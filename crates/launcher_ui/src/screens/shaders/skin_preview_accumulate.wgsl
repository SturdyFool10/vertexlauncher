...
@binding(0) @group(1) var<uniform> scalar_0 : Scalar_std140_0;
...
fn fs_main(@builtin(position) pos_1 : vec4<f32>) -> pixelOutput_0
{
    ...
    var _S4 : pixelOutput_0 = pixelOutput_0( (textureLoad((source_tex_0), ((_S3)).xy, ((_S3)).z)) * vec4<f32>(scalar_0.value_0.x) );
    return _S4;
}
